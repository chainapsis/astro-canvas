...
// ExportAppStateAndValidators export the state of astro for a genesis file
func (app *AstroApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *AstroApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
