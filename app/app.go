...
const appName = "AstroApp"

var (
	// DefaultCLIHome default home directories for astrocli
	DefaultCLIHome = os.ExpandEnv("$HOME/.astrocli")

	// DefaultNodeHome default home directories for astrod
	DefaultNodeHome = os.ExpandEnv("$HOME/.astrod")
...
// AstroApp extended ABCI application
...
// NewAstroApp returns a reference to an initialized AstroApp.
func NewAstroApp(
...
func (app *AstroApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *AstroApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *AstroApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *AstroApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *AstroApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *AstroApp) ModuleAccountAddrs() map[string]bool {
...
func (app *AstroApp) BlacklistedAccAddrs() map[string]bool {
...
// Codec returns AstroApp's codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *AstroApp) Codec() *codec.Codec {
	return app.cdc
}
